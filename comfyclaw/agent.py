...
class ClawAgent:
    ...
    def plan_and_patch(
        ...
        The actual conversation runs inside the configured
        :class:`~comfyclaw.agent_backends.AgentBackend` (LiteLLM by
        default; Claude Code / Codex / Gemini CLI sessions optional).
