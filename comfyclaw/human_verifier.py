...
class HumanVerifier:
    ...
    def _verify_via_websocket(self, image_path: str, prompt: str, iteration: int) -> VerifierResult:
        print(
            f"[HumanVerifier] 📝 Requesting feedback via ComfyUI panel (timeout {self._timeout}s)…"
        )
...
class HybridVerifier:
    ...
    def _hybrid_via_websocket(
        ...
        print("[HybridVerifier] 📝 Requesting human review via ComfyUI panel…")
        self._sync.request_feedback(
            image_path=image_path,
